...
digraph G {
    ...
    A [label="🚶‍♂️ Επισκέπτης\\n(100%)"];
    B [label="✍️ Εγγραφή\\n(20%–25%)"];
    C [label="📝 Συμπλ. Προφίλ\\n(45%–60%)"];
    D [label="🔍 Αναζήτηση Σπιτιού\\n(75%–85%)"];
    E [label="⛔ Όριο Credits\\n(50%–70%)"];
    F [label="💳 Αγορά Credits\\n(15%–25%)"];

    A -> B [label="signup"];
    B -> C [label="profile"];
    C -> D [label="αναζήτηση"];
    D -> E [label="credits exhausted"];
    E -> F [label="αγορά"];
}
"""

st.subheader("🧭 Διάγραμμα Πορείας Χρήστη (Conversion Funnel)")
st.graphviz_chart(funnel_diagram)
